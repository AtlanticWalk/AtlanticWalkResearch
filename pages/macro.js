...
export default function MacroPage({ reports }) {
  ...
  return (
    <>
      <Head>
        <title>Macro Research | Atlantic Walk Research</title>
        <meta
          name="description"
          content="Macro and thematic research from Atlantic Walk Research — sector frameworks, procurement landscapes, and investment theses."
        />
      </Head>
      ...
      <main className="max-w-3xl mx-auto px-4 pt-20 md:pt-28 pb-24">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Macro Research</h1>
          <p className="text-gray-300 text-base mt-1">
            Thematic frameworks, sector deep-dives, and macro investment theses.
          </p>
        </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border border-gray-800 rounded-xl px-6 py-5 bg-neutral-900/50">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-0.5">New reports and frameworks — no spam, unsubscribe anytime.</p>
          </div>
          <button
